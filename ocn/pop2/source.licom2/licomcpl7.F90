...
!
  ...
  !subroutine licom_import_mct(x2o_o,r2x_o)
    type(mct_aVect)   , intent(inout) ::  x2o_o
    !type(mct_aVect)   , intent(inout) :: r2x_o !LPF 20121219
    ! local
    ...
    if (iy == 0) then
       ...
       ! do j=1+1,j_num+1
        ...
        do i=1+1,i_num+1 !2,i_num+1 !LPF 20120818  
           ...
           !roff (i,j) = r2x_o%rAttr(index_r2o_Forr_roff,n)    ! runoff  !LPF 20121219
           !roff (i,j) = r2x_rx%rAttr    ! runoff  !LPF 20121219

...
1000    continue
    ...
    Subroutine dyn_time_scale_calc(Ri,Rrho,pi_n,Gm, cubic_coef)
        implicit none
    ...
    subroutine canuto_2010_interface(Km_out,    Kh_out,     Ks_out,     Kd_out,     mld_out,&
        ...
        do k = 1, num_lev - 1
            ...
            call dyn_time_scale_calc(1.0d10,Rrho(k),out_pi(:),Gm(k),cube)
            ...
            call dyn_time_scale_calc(Ri(k),Rrho(k),out_pi(:),Gm(k),cube)
...
!
                ...
                Ks_out(k) = max(0.1D-4, Ks_out(k))
!
!               if (mytid ==6 .and. i ==32 .and. j== 17 .and. isc ==41 .and. k == 5 ) then
!                   write(125,*) out_pi, ri(k), rrho(k), gm(k)
!                   close(125)
!               end if
!
